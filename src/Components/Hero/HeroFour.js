                            ...
                            <div className="row">
                                <div className="col-xl-9 col-md-10 col-12">
                                    <div className="hero-contents">
                                        ...
                                        <Link to='/products' className="theme-btn animated-text animated-btn style-4 mt-30">Explore products</Link>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="single-agency-slide bg-cover" style={{backgroundImage: `url(${slide1})`}}>
                        <div className="container">
                            <div className="row">
                                <div className="col-xl-9 col-md-10 col-12">
                                    <div className="hero-contents">
                                        <h1 className="animated-text bg-heading text-white animated">JM GEARS Web Agency</h1>
                                        <Link to='/products' className="theme-btn animated-text animated-btn style-4 mt-30">Explore products</Link>
                                    </div>
                                </div>
                            </div>
