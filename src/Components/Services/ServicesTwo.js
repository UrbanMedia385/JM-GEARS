...
import productsTwoData from './servicesTwoData'
                        ...
                        <div className="col-xl-4 col-md-6 col-12" key={data.id}>
                            <div className="single-service-card">
                                ...
                                <div className="content">
                                    ...
                                    <p>{data.desc}</p>
                                    <Link to="/productsDetails" className="read-more">Read More <i className="fal fa-arrow-right"></i></Link>
                                </div>
                            </div>
                        </div>
                    ))
