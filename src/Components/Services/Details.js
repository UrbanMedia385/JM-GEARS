...
const Details = (selectedProduct) => {
    ...
    console.log(selectedProduct.selectedProduct.img)
    return (
    ...
    <div className="container">
        ...
        <div className="col-lg-9 col-md-8 ps-lg-5 col-12 order-1 order-md-2">
            ...
            <img src={image1} alt=""/>
            <h2>{selectedProduct.selectedProduct.title}</h2>
            <p>{selectedProduct.selectedProduct.desc}</p>
            ...
            <div className="faq-accordion">
                ...
                <div className="accordion-item">
                    ...
                    <button className="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#faq2" aria-expanded="true" aria-controls="faq2">
                        What products do architects provide?
                    </button>
                    </h4>
